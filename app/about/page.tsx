            ...
            <div className="grid w-full grid-cols-8 gap-16 z-0">
                <div className="col-span-3 flex flex-col items-start justify-start gap-4">
                    ...
                    <p className="font-medium">
                        Hi, I'm Kerem, a web developer with a passion for creating beautiful, functional, and user-centered digital experiences. With 2 years of experience in the field. I am always
