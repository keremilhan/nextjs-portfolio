            ...
            <div className="flex items-center justify-between w-full lg:flex-col lg:mb-0 mb-auto">
                ...
                <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
                    ...
                    <p className="my-4 text-base font-medium md:text-small sm:text-xs">
                        As a skilled full-stack developer, I am dedicated to turning ideas into innovative web applications. Explore my latest projects showcasing my expertise in React.js and web
                        development.
                    </p>
                    <div className="flex items-center self-start mt-2 lg:self-center md:mb-8">
                        <Link
                        ...
                        <Link href="mailto:kerem7095@gmail.com" target="_blank" className="ml-4 text-lg font-medium capitilize text-dark underline dark:text-light md:text-">
                            Contact
                        </Link>
                    </div>
                </div>
